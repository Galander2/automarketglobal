...
const List<Dealer> dealers = [
  Dealer(
    ...
    country: 'ОАЭ',
    city: 'Dubai',
    description: 'Крупный дилер с доставкой автомобилей под ключ по Центральной Азии.',
  ...
  Dealer(
    ...
    country: 'Южная Корея',
    city: 'Seoul',
    description: 'Поставки автомобилей из Кореи с проверкой документов и истории.',
  ...
  Dealer(
    ...
    country: 'Китай',
    city: 'Guangzhou',
    description: 'Электромобили и новые автомобили из Китая с международной доставкой.',
